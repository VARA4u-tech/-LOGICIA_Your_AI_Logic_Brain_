...
const StatCard = ({
  ...
  const displayValue = value % 1 === 0 ? Math.round(animatedValue) : animatedValue.toFixed(1);
...
const FeaturesSection = () => {
  ...
  return (
    <section id="features" ref={ref} className="relative z-10 py-20 sm:py-24 px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-16 sm:mb-20">
          {features.map((feat, i) => (
            ...
            >
              ...
              <h3 className="font-display text-xs sm:text-sm tracking-[0.2em] text-primary mb-2 sm:mb-3">{feat.title}</h3>
