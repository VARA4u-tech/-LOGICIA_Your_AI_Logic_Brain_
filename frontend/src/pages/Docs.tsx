    ...
    <div className="space-y-12 animate-fade-in-up">
      ...
      <div className="space-y-10 font-body text-[13px] text-foreground/70 leading-relaxed max-w-3xl">
        <section className="space-y-4">
          <h3 className="font-display text-xs tracking-widest text-primary uppercase">01. Academic Status</h3>
          <p>
            Logicia is a <strong>college-based project application</strong> developed strictly for educational and demonstration purposes. It is not a commercial product. By using this platform, you acknowledge its academic nature and understand that it is provided "as is" for pedagogical exploration.
          </p>
        </section>

        <section className="space-y-4">
          <h3 className="font-display text-xs tracking-widest text-primary uppercase">02. Acceptable Usage</h3>
          <p>
            Users are responsible for maintaining the integrity of their interactions. The engine is designed for mathematical inquiry. Any attempt to reverse-engineer, exploit the API, or use the service for non-educational malicious activity is strictly prohibited.
          </p>
        </section>

        <section className="space-y-4">
          <h3 className="font-display text-xs tracking-widest text-primary uppercase">03. Limitation of Liability</h3>
          <p>
            As a research project, we do not guarantee 100% availability or total accuracy of pedagogical explanations generated by third-party LLM orchestrations. Logicia and its creators shall not be liable for any academic or data-related consequences arising from the use of this demonstration platform.
          </p>
        </section>

        <section className="space-y-4">
          <h3 className="font-display text-xs tracking-widest text-primary uppercase">04. Responsible Handling</h3>
          <p>
            User data is handled with strict academic integrity. We do not monetize or sell user information. All data handling protocols are designed to support the functionality of the project while respecting individual user privacy.
          </p>
        </section>
      </div>
    </div>
...
const PrivacyContent = () => {
  return (
    <div className="space-y-12 animate-fade-in-up">
      ...
      <div className="space-y-10 font-body text-[13px] text-foreground/70 leading-relaxed max-w-3xl">
        <section className="space-y-4">
          <h3 className="font-display text-xs tracking-widest text-primary uppercase">Data Collection Breakdown</h3>
          <p>
            For the purpose of providing a personalized chat experience and academic tracking, we collect the following limited data points:
          </p>
          <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
            <li><strong>Identity:</strong> Name and Email address via Google OAuth.</li>
            <li><strong>Interaction Data:</strong> Mathematical queries and generated steps for session persistence.</li>
            <li><strong>Technical Logic:</strong> Basic usage activity to optimize engine latency.</li>
          </ul>
        </section>

        <section className="space-y-4">
          <h3 className="font-display text-xs tracking-widest text-primary uppercase">Utilization of Information</h3>
          <p>
            Your data is used exclusively to:
          </p>
          <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
            <li>Authenticate and maintain secure user sessions.</li>
            <li>Enable cross-device access to your mathematical conversation history.</li>
            <li>Analyze engine performance for academic research and platform improvement.</li>
          </ul>
        </section>

        <section className="space-y-4">
          <h3 className="font-display text-xs tracking-widest text-primary uppercase">Third-Party Governance</h3>
          <p>
            We do not share your personal identity with third parties. Mathematical queries (stripped of PII) may be processed via OpenRouter's LLM orchestration to generate pedagogical explanations. We are committed to a strict "no-monetization" policy for all academic data.
          </p>
        </section>

        <section className="space-y-4">
          <h3 className="font-display text-xs tracking-widest text-primary uppercase">Data Protection</h3>
          <p>
            We implement industry-standard encryption and secure token-based authentication (JWT) to safeguard your session data. As this is a college project, we encourage users not to share sensitive personal information within the mathematical chat interface.
          </p>
        </section>
      </div>
    </div>
