  ...
  return (
    <div className="min-h-screen bg-background font-body selection:bg-primary/30 selection:text-primary overflow-hidden relative">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-blue-500/10 blur-[150px] rounded-full animate-pulse"
          ...
          <div className="hidden lg:flex flex-col justify-between p-12 bg-gradient-to-br from-primary/10 via-primary/5 to-transparent relative overflow-hidden group">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-8">
                ...
                <span className="font-display font-black tracking-[0.3em] text-primary neon-text">
                  LOGICIA
                </span>
              </div>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    text: "Competitive Exam Specialists",
                  },
                  {
                  ...
                  <li
                    key={i}
                    className="flex items-center gap-3 text-muted-foreground/80 font-display text-xs tracking-widest uppercase"
                  >
            ...
            <div className="w-full max-w-sm text-center lg:text-left space-y-8">
              <div className="space-y-2">
                <h2 className="text-2xl sm:text-3xl font-display font-black text-white tracking-tight">
                  Welcome to{" "}
                  <span className="text-primary neon-text">Logicia</span>.
                </h2>
                <p className="text-muted-foreground font-body text-[14px] leading-relaxed">
                  Join the elite group of students using AI to master complex
