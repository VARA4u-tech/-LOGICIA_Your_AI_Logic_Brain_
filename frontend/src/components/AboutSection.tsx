        ...
        >
          ...
          <div className="space-y-5 sm:space-y-6">
            <p className="text-xs sm:text-sm text-foreground/80 leading-relaxed font-body">
              LOGICIA is a next-generation intelligent math solver built to
              handle everything from basic arithmetic to advanced calculus.
              Powered by a hybrid AI + symbolic engine, it delivers instant,
              accurate solutions with detailed step-by-step explanations.
            </p>
            <p className="text-xs sm:text-sm text-foreground/80 leading-relaxed font-body">
