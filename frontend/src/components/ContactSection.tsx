...
const ContactSection = () => {
  ...
  return (
    <section
      id="contact"
      className="relative z-10 py-20 sm:py-24 px-4 bg-gradient-to-t from-background via-background to-transparent"
    >
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-start">
          ...
          <div className="space-y-8 sm:space-y-10 order-2 md:order-1">
            <p className="text-xs sm:text-sm text-foreground/80 leading-loose font-body bg-primary/5 p-5 rounded-xl border border-primary/10">
              ...
              hear from you. Fill out the form or reach out directly, and our
